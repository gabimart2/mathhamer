...
/**
 * Componente DiceSkillInput: alterna entre modo numérico (>=1)
 ...
 */
const DiceSkillInput = ({ label, initialValue, onChange }) => {
  ...
  useEffect(() => {
    ...
    if (diceMatch) {
      ...
      setDiceMode(false);
      setNumericValue(isNaN(num) || num < 1 ? 1 : num);
      setDiceCount(1);
      setSides(3);
      setModifier(0);
    }
        ...
        startAdornment: diceMode && (
          <InputAdornment position="start">
            <Box display="flex" flexDirection="column" alignItems="center">
              ...
              <IconButton size="small" onClick={decPrefix}>
          ...
          <InputAdornment position="end">
            {diceMode ? (
              <Box display="flex" flexDirection="column" alignItems="center" mr={1}>
                ...
                <IconButton size="small" onClick={decModifier}>
                  <ArrowDropDownIcon fontSize="small" />
                </IconButton>
              </Box>
            ) : (
              <Box display="flex" flexDirection="column" alignItems="center">
                ...
                <IconButton size="small" onClick={decNumeric}>
                  <ArrowDropDownIcon fontSize="small" />
                </IconButton>
              </Box>
            )}
...
DiceSkillInput.propTypes = {
  initialValue: PropTypes.string,
  onChange: PropTypes.func,
};

DiceSkillInput.defaultProps = {
  initialValue: '1',
  onChange: null,
};

export default DiceSkillInput;
